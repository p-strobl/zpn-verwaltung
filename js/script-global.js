...
const showFailMessage = {
    ...
    failMessage: function(errorClassType, setTimeoutTimer, thisObject) {
        switch (thisObject) {
            case "header-input-eingang":
            case "header-input-verwaltung":
                this.$wrapContent.hasClass("displayNoneImportant") === true
                    ? this.$headerFailMessageWrap
                          .addClass("border-edged")
                          .add(
                              this.$headerInputEingang.removeClass(
                                  "border-edged"
                              )
                          )
                    : "";
                this.$headerFailMessageContent.addClass(errorClassType);
                this.$headerFailMessageWrap.addClass(
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        this.$wrapContent.hasClass("displayNoneImportant") ===
                        true
                            ? this.$headerFailMessageWrap
                                  .removeClass("border-edged")
                                  .add(
                                      this.$headerInputEingang.addClass(
                                          "border-edged"
                                      )
                                  )
                            : "";
                        this.$headerFailMessageContent.removeClass(
                            errorClassType
                        );
                    }, 330);
                }, setTimeoutTimer);
            ...
            case "deactive":
                ...
                switch (this.id) {
                    ...
                    case "content-btn-chkKlaerBack":
                        effectOnElement(
                            $footerAnzahlKlaerfall,
                            '#content-btn-chkKlaerBack[value="active"]',
                            {
                                color: "#FFB700"
                            }
                        );
                    ...
                    case "content-btn-chkNickelBack":
                        effectOnElement(
                            $footerAnzahlNickelBack,
                            '#content-btn-chkNickelBack[value="active"]',
                            {
                                color: "#FFB700"
                            }
                        );
                    ...
                    case "content-btn-zerlegungStart":
                        effectOnElement(
                            $footerAnzahlZerlegungStart,
                            '#content-btn-zerlegungStart[value="active"]',
                            {
                                color: "#FFB700"
                            }
                        );
                        ...
                        disableButton(
                            this,
                            "#content-btn-zerlegungEnde",
                            "disableMainRowButton"
                        );
                        disableButton(
                            this,
                            "#content-btn-einwaageBeginn",
                            "disableMainRowButton"
                        );
                        disableButton(
                            this,
                            "#content-btn-einwaageEnde",
                            "disableMainRowButton"
                        );
                        disableButton(
                            this,
                            "#content-btn-klaerfallBeginn",
                            "disableMainRowButton"
                        );
                        disableButton(
                            this,
                            "#content-btn-klaerfallEnde",
                            "disableMainRowButton"
                        );
                        disableButton(
                            this,
                            "#content-btn-manaBestellt",
                            "disableMainRowButton"
                        );
                        disableButton(
                            this,
                            "#content-btn-manaErhalten",
                            "disableMainRowButton"
                        );
                        disableButton(
                            this,
                            "#content-btn-manaEinwaage",
                            "disableMainRowButton"
                        );
                        disableButton(
                            this,
                            "#content-btn-manaEingewogen",
                            "disableMainRowButton"
                        );
                        disableButton(
                            this,
                            "#content-btn-zpnWagen",
                            "disableMainRowButton"
                        );
                        break;
                    ...
                    case "content-btn-zerlegungEnde":
                        effectOnElement(
                            $footerAnzahlZerlegungEnde,
                            '#content-btn-zerlegungEnde[value="active"]',
                            {
                                color: "#FFB700"
                            }
                        );
                    ...
                    case "content-btn-einwaageBeginn":
                        effectOnElement(
                            $footerAnzahlEinwaageBeginn,
                            '#content-btn-einwaageBeginn[value="active"]',
                            {
                                color: "#FFB700"
                            }
                        );
                    ...
                    case "content-btn-einwaageEnde":
                        effectOnElement(
                            $footerAnzahlEinwaageEnde,
                            '#content-btn-einwaageEnde[value="active"]',
                            {
                                color: "#FFB700"
                            }
                        );
                    ...
                    case "content-btn-klaerfallBeginn":
                        effectOnElement(
                            $footerAnzahlKlaerfallBeginn,
                            '#content-btn-klaerfallBeginn[value="active"]',
                            {
                                color: "#FFB700"
                            }
                        );
                    ...
                    case "content-btn-klaerfallEnde":
                        effectOnElement(
                            $footerAnzahlKlaerfallEnde,
                            '#content-btn-klaerfallEnde[value="active"]',
                            {
                                color: "#FFB700"
                            }
                        );
                    ...
                    case "content-btn-manaBestellt":
                        effectOnElement(
                            $footerAnzahlManaBestellt,
                            '#content-btn-manaBestellt[value="active"]',
                            {
                                color: "#FFB700"
                            }
                        );
                    ...
                    case "content-btn-manaErhalten":
                        effectOnElement(
                            $footerAnzahlManaErhalten,
                            '#content-btn-manaErhalten[value="active"]',
                            {
                                color: "#FFB700"
                            }
                        );
                    ...
                    case "content-btn-manaEinwaage":
                        effectOnElement(
                            $footerAnzahlManaEinwaage,
                            '#content-btn-manaEinwaage[value="active"]',
                            {
                                color: "#FFB700"
                            }
                        );
                    ...
                    case "content-btn-manaEingewogen":
                        effectOnElement(
                            $footerAnzahlManaEingewogen,
                            '#content-btn-manaEingewogen[value="active"]',
                            {
                                color: "#FFB700"
                            }
                        );
                    ...
                    case "content-btn-zpnWagen":
                        ...
                        effectOnElement(
                            $footerAnzahlZpnWagen,
                            '#content-btn-zpnWagen[value="active"]',
                            {
                                color: "#FFB700"
                            }
                        );
            ...
            case "active":
                ...
                switch (this.id) {
                    case "content-btn-chkEx":
                        effectOnElement(
                            $footerAnzahlExpress,
                            '#content-btn-chkEx[value="active"]',
                            {
                                color: "#FF3100"
                            }
                        );
                    ...
                    case "content-btn-chkIntern":
                        effectOnElement(
                            $footerAnzahlIntern,
                            '#content-btn-chkIntern[value="active"]',
                            {
                                color: "#FF3100"
                            }
                        );
                    ...
                    case "content-btn-chkNi":
                        effectOnElement(
                            $footerAnzahlNickel,
                            '#content-btn-chkNi[value="active"]',
                            {
                                color: "#FF3100"
                            }
                        );
                    ...
                    case "content-btn-chkLF":
                        effectOnElement(
                            $footerAnzahlLFGB,
                            '#content-btn-chkLF[value="active"]',
                            {
                                color: "#FF3100"
                            }
                        );
                    ...
                    case "content-btn-chkToy":
                        effectOnElement(
                            $footerAnzahlToys,
                            '#content-btn-chkToy[value="active"]',
                            {
                                color: "#FF3100"
                            }
                        );
                    ...
                    case "content-btn-chk60g":
                        effectOnElement(
                            $footerAnzahl60g,
                            '#content-btn-chk60g[value="active"]',
                            {
                                color: "#FF3100"
                            }
                        );
                ...
                case "active":
                    ...
                    switch (this.id) {
                        ...
                        case "content-btn-nickelBack":
                            effectOnElement(
                                $footerAnzahlNickelBack,
                                '#content-btn-nickelBack[value="active"]',
                                {
                                    color: "#FF3100"
                                }
                            );
